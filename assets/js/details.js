...
let eventoObjetivo = data.events.find(evento => evento._id === Number(id));

$main.innerHTML += `<div class="container bg-dark p-0 d-flex flex-column gap-2 p-2 w-90 border border-5" id="contenedor-details">
